...
//                || request.getName().trim().length() == 0) {
//            throw new IllegalArgumentException("Ten sach khong duoc de trong");
//        }
//
//        if (request.getName().length() > 100) {
//            throw new IllegalArgumentException("Ten sach khong duoc qua 100 ky tu");
//        }
...
//        book.setPrice(request.getPrice());
    ...
    public BookResponse getDetail(Integer id) throws ObjectNotFoundException {
