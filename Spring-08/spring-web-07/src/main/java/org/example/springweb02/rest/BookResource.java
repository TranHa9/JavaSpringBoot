...
//    }
    ...
    @GetMapping("/{id}")
    public BookResponse getBookDetail(@PathVariable Integer id) throws ObjectNotFoundException {
        return bookService.getDetail(id);
    }

    @PostMapping
    public BookResponse createBook(@RequestBody @Valid BookCreationRequest request) {
